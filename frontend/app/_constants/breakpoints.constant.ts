 ...
 * Source: https://pgarciacamou.medium.com/media-queries-with-css-in-jss-using-emotion-react-70bdb49d45c8
 */
...
export const extraSmallAndBigger = `@media only screen and (min-width: ${SIZE_EXTRA_SMALL}px)`
